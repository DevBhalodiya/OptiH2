  ...
  return (
    <header className="sticky top-0 z-50 bg-background/80 backdrop-blur-xl border-b border-glass-border shadow-lg shadow-glass-shadow">
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4">
        {/* Logo */}
        <Link href="/" aria-label="Green Hydrogen InfraMap" className="flex items-center gap-3 group">
          ...
          <div className="hidden sm:block">
            <span className="text-xl font-bold text-foreground">Green Hydrogen</span>
            <span className="text-xl font-bold gradient-text ml-2">InfraMap</span>
          </div>
        </Link>
